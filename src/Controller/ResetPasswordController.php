...
class ResetPasswordController extends AbstractController
{
    ...
    public function index(Request $request): Response
    {
        ...
        if($request->get('email')){
            ...
            if($user){
                // 1 : Enregister en base la demmande de rest_password avec user, token ,createdAt.
                ...
                $content = "Bonjour ".$user->getFirstname().",<br/> Vous avez demandé à réinitiliser votre mot de passe <br/> <br/>";
                ...
                $this->addFlash('notice', 'Vous allez recevoir dans quelques instants un email de réinitialisation de mot de passe.');
            }else{
    ...
    public function update(Request $request, $token, UserPasswordEncoderInterface $encoder)
    {
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            // Redirection de l'utitlisateur vers la page de connexion.
